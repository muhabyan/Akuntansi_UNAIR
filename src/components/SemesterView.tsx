                ...
                {group.courses.map(course => {
                  ...
                  return (
                    <button
                      ...
                      className="flex flex-col rounded-xl border border-gray-200 bg-white p-5 text-left shadow-sm hover:shadow-md hover:border-blue-300 transition-all dark:border-gray-700 dark:bg-gray-800 dark:hover:border-blue-500"
                    >
                      {/* Top: Code + SKS */}
                      ...
                      <div className="mt-auto">
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1">
                            <CheckCircle2 size={12} className={done > 0 ? 'text-blue-500' : ''} />
                            {pct}% selesai
                          </span>
