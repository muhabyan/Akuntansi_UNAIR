...
const MAS122_REVIEW_UAS_READING: Reading = {
  ...
  blocks: [
    ...
    { kind: 'h2', text: 'B. Pohon Keputusan Pemilihan Uji Statistik (Parametrik vs Non-Parametrik)' },
    {
      ...
      svg: `<svg viewBox="0 0 650 310" class="course-diagram-svg" style="width:100%;height:auto;font-family:Manrope,Inter,-apple-system,BlinkMacSystemFont,sans-serif"><rect class="svg-bg" width="650" height="310" rx="12" fill="#0f172a" stroke="#334155" stroke-width="1.5"/><rect class="svg-subcard" x="225" y="15" width="200" height="38" rx="8" fill="#1e293b" stroke="#38bdf8"/><text class="text-accent-blue" x="325" y="39" fill="#38bdf8" font-size="12" font-weight="bold" text-anchor="middle">Tujuan Uji Rata-rata / Peringkat</text><line class="svg-divider" x1="325" y1="53" x2="160" y2="90" stroke="#64748b" stroke-width="2"/><line class="svg-divider" x1="325" y1="53" x2="490" y2="90" stroke="#64748b" stroke-width="2"/><rect class="svg-card" x="70" y="90" width="180" height="34" rx="6" fill="#1e293b" stroke="#64748b"/><text class="svg-title" x="160" y="112" fill="#0f172a" font-size="11" font-weight="bold" text-anchor="middle">2 Kelompok Sampel</text><rect class="svg-card" x="400" y="90" width="180" height="34" rx="6" fill="#1e293b" stroke="#64748b"/><text class="svg-title" x="490" y="112" fill="#0f172a" font-size="11" font-weight="bold" text-anchor="middle">&gt; 2 Kelompok (Banyak)</text><line class="svg-divider" x1="160" y1="124" x2="80" y2="165" stroke="#64748b" stroke-width="1.5"/><line class="svg-divider" x1="160" y1="124" x2="240" y2="165" stroke="#64748b" stroke-width="1.5"/><rect class="svg-subcard" x="10" y="165" width="140" height="48" rx="6" fill="#059669" fill-opacity="0.2" stroke="#10b981"/><text class="text-accent-green" x="80" y="185" fill="#34d399" font-size="11" font-weight="bold" text-anchor="middle">Independen (Bebas)</text><text class="svg-text" x="80" y="203" fill="#cbd5e1" font-size="10" text-anchor="middle">t-test / Mann-Whitney</text><rect class="svg-subcard" x="170" y="165" width="140" height="48" rx="6" fill="#059669" fill-opacity="0.2" stroke="#10b981"/><text class="text-accent-green" x="240" y="185" fill="#34d399" font-size="11" font-weight="bold" text-anchor="middle">Berpasangan (Paired)</text><text class="svg-text" x="240" y="203" fill="#cbd5e1" font-size="10" text-anchor="middle">Paired t / Wilcoxon</text><line class="svg-divider" x1="490" y1="124" x2="410" y2="165" stroke="#64748b" stroke-width="1.5"/><line class="svg-divider" x1="490" y1="124" x2="570" y2="165" stroke="#64748b" stroke-width="1.5"/><rect class="svg-subcard" x="340" y="165" width="140" height="48" rx="6" fill="#d97706" fill-opacity="0.2" stroke="#f59e0b"/><text class="text-accent-amber" x="410" y="185" fill="#fbbf24" font-size="11" font-weight="bold" text-anchor="middle">Normal / Interval</text><text class="svg-text" x="410" y="203" fill="#cbd5e1" font-size="10" text-anchor="middle">One-way / Two-way ANOVA</text><rect class="svg-subcard" x="500" y="165" width="140" height="48" rx="6" fill="#dc2626" fill-opacity="0.2" stroke="#ef4444"/><text class="text-accent-red" x="570" y="185" fill="#f87171" font-size="11" font-weight="bold" text-anchor="middle">Ordinal / Non-Normal</text><text class="svg-text" x="570" y="203" fill="#cbd5e1" font-size="10" text-anchor="middle">Kruskal-Wallis Test</text><text class="svg-muted" x="325" y="260" fill="#94a3b8" font-size="11" text-anchor="middle">*Aturan Emas: Jika syarat Normalitas atau Homogenitas Varians (Levene) dilanggar,</text><text class="text-accent-red font-bold" x="325" y="278" fill="#f87171" font-size="11" font-weight="bold" text-anchor="middle">selalu gunakan alternatif Statistik Non-Parametrik (Mann-Whitney, Wilcoxon, Kruskal-Wallis)!</text></svg>`,
