...
export const AKS301_READINGS: Record<number, Reading> = {
  1: {
    ...
    blocks: [
      {
        kind: 'figure',
        caption: 'Gambar 1.1: Transformasi Data Menjadi Nilai Bisnis dalam Kerangka Rantai Nilai SIA.',
  ...
  <text class="svg-title text-accent-blue" x="340" y="34" fill="#38bdf8" font-size="13" font-weight="700" text-anchor="middle">SIA DALAM RANTAI NILAI BISNIS (VALUE CHAIN &amp; AIS TRANSFORMATION)</text>

  <!-- Left: Inputs -->
  <rect class="svg-card" x="25" y="58" width="135" height="170" rx="8" fill="#1e293b" stroke="#38bdf8" stroke-width="1.5"/>
  <text class="text-accent-blue" x="92" y="80" fill="#38bdf8" font-size="11" font-weight="700" text-anchor="middle">1. INPUT DATA</text>
  <line class="svg-divider" x1="35" y1="90" x2="150" y2="90" stroke="#334155"/>
  <text class="svg-text" x="92" y="110" fill="#cbd5e1" font-size="9" text-anchor="middle">&#8226; Faktur Penjualan</text>
  <text class="svg-text" x="92" y="128" fill="#cbd5e1" font-size="9" text-anchor="middle">&#8226; Dokumen PO &amp; LPB</text>
  <text class="svg-text" x="92" y="146" fill="#cbd5e1" font-size="9" text-anchor="middle">&#8226; Presensi &amp; Jam Kerja</text>
  <text class="svg-text" x="92" y="164" fill="#cbd5e1" font-size="9" text-anchor="middle">&#8226; Log Transaksi Kas</text>
  <rect class="svg-subcard" x="35" y="180" width="115" height="36" rx="4" fill="#0f172a" stroke="#0284c7"/>
  <text class="svg-muted" x="92" y="196" fill="#94a3b8" font-size="8" text-anchor="middle">Data Mentah Bisnis</text>
  <text class="text-accent-blue" x="92" y="208" fill="#38bdf8" font-size="8" font-weight="600" text-anchor="middle">Sumber Bukti Transaksi</text>

  <!-- Middle: SIA Engine -->
  <rect class="svg-card" x="180" y="58" width="320" height="170" rx="8" fill="#1e293b" stroke="#34d399" stroke-width="1.5"/>
  <text class="text-accent-green" x="340" y="80" fill="#34d399" font-size="11" font-weight="700" text-anchor="middle">2. PROSES PENGOLAHAN &amp; KONTROL SIA</text>
  <line class="svg-divider" x1="195" y1="90" x2="485" y2="90" stroke="#334155"/>
  
  <rect class="svg-subcard" x="195" y="100" width="135" height="52" rx="6" fill="#0f172a" stroke="#334155"/>
  <text class="text-accent-green" x="262" y="118" fill="#34d399" font-size="9" font-weight="700" text-anchor="middle">Pencatatan &amp; Validasi</text>
  <text class="svg-muted" x="262" y="132" fill="#94a3b8" font-size="8" text-anchor="middle">Input Controls &amp; Edit Check</text>
  <text class="svg-muted" x="262" y="144" fill="#94a3b8" font-size="8" text-anchor="middle">Pemisahan Tugas (SoD)</text>

  <rect class="svg-subcard" x="350" y="100" width="135" height="52" rx="6" fill="#0f172a" stroke="#334155"/>
  <text class="text-accent-amber" x="417" y="118" fill="#fbbf24" font-size="9" font-weight="700" text-anchor="middle">Penyimpanan Database</text>
  <text class="svg-muted" x="417" y="132" fill="#94a3b8" font-size="8" text-anchor="middle">RDBMS Terintegrasi (REA)</text>
  <text class="svg-muted" x="417" y="144" fill="#94a3b8" font-size="8" text-anchor="middle">Integritas Referential Data</text>

  <rect class="svg-subcard" x="195" y="162" width="290" height="54" rx="6" fill="#0f172a" stroke="#10b981"/>
  <text class="text-accent-green" x="340" y="180" fill="#34d399" font-size="9" font-weight="700" text-anchor="middle">Penciptaan Nilai Rantai Bisnis (Value Chain Margin)</text>
  <text class="svg-text" x="340" y="195" fill="#cbd5e1" font-size="8" text-anchor="middle">Logistik Masuk &#8594; Operasi &#8594; Logistik Keluar &#8594; Pemasaran &#8594; Pelayanan</text>
  <text class="svg-muted" x="340" y="208" fill="#94a3b8" font-size="7.5" text-anchor="middle">Didukung Infrastruktur TI, SDM, Pengadaan, &amp; Akuntansi Manajemen</text>

  <!-- Right: Outputs -->
  <rect class="svg-card" x="520" y="58" width="135" height="170" rx="8" fill="#1e293b" stroke="#f59e0b" stroke-width="1.5"/>
  <text class="text-accent-amber" x="587" y="80" fill="#f59e0b" font-size="11" font-weight="700" text-anchor="middle">3. OUTPUT KEPUTUSAN</text>
  <line class="svg-divider" x1="530" y1="90" x2="645" y2="90" stroke="#334155"/>
  <text class="svg-text" x="587" y="110" fill="#cbd5e1" font-size="9" text-anchor="middle">&#8226; Laporan Keuangan</text>
  <text class="svg-text" x="587" y="128" fill="#cbd5e1" font-size="9" text-anchor="middle">&#8226; KPI &amp; Aging Piutang</text>
  <text class="svg-text" x="587" y="146" fill="#cbd5e1" font-size="9" text-anchor="middle">&#8226; Laporan Audit Trail</text>
  <text class="svg-text" x="587" y="164" fill="#cbd5e1" font-size="9" text-anchor="middle">&#8226; Dashboard Eksekutif</text>
  <rect class="svg-subcard" x="530" y="180" width="115" height="36" rx="4" fill="#0f172a" stroke="#d97706"/>
  <text class="text-accent-amber" x="587" y="196" fill="#fbbf24" font-size="8" font-weight="600" text-anchor="middle">Informasi Berkualitas</text>
  <text class="svg-muted" x="587" y="208" fill="#94a3b8" font-size="7.5" text-anchor="middle">Relevance &amp; Faithful Rep</text>
</svg>`,
      },
  ...
  "blocks": [
      {
        "kind": "figure",
        "caption": "Gambar 2.1: Standar Notasi Pemodelan Proses Bisnis BPMN 2.0 dan Pemisahan Tugas (SoD).",
        "svg": "<svg class=\"course-diagram-svg\" viewBox=\"0 0 680 250\" xmlns=\"http://www.w3.org/2000/svg\" style=\"width:100%;height:auto;font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif\">\n  <rect class=\"svg-bg\" x=\"10\" y=\"10\" width=\"660\" height=\"230\" rx=\"12\" fill=\"#0f172a\" stroke=\"#334155\" stroke-width=\"1.5\"/>\n  <rect class=\"svg-header\" x=\"10\" y=\"10\" width=\"660\" height=\"38\" rx=\"12\" fill=\"#1e293b\" fill-opacity=\"0.6\"/>\n  <line class=\"svg-divider\" x1=\"10\" y1=\"48\" x2=\"670\" y2=\"48\" stroke=\"#334155\" stroke-width=\"1\"/>\n  <text class=\"svg-title text-accent-purple\" x=\"340\" y=\"34\" fill=\"#a855f7\" font-size=\"13\" font-weight=\"700\" text-anchor=\"middle\">ARSITEKTUR PEMODELAN PROSES BISNIS (BPMN 2.0 STANDARD)</text>\n\n  <!-- Top Pool: Pelanggan (Black-Box Pool) -->\n  <rect class=\"svg-card\" x=\"30\" y=\"58\" width=\"620\" height=\"42\" rx=\"6\" fill=\"#1e293b\" stroke=\"#38bdf8\" stroke-width=\"1.5\"/>\n  <text class=\"text-accent-blue\" x=\"90\" y=\"83\" fill=\"#38bdf8\" font-size=\"10.5\" font-weight=\"700\">POOL 1: PELANGGAN EKSTERNAL</text>\n  <text class=\"svg-muted\" x=\"420\" y=\"83\" fill=\"#94a3b8\" font-size=\"9\">Mengirim Pesanan (Message Flow &#8595;) &amp; Menerima Faktur Tagihan</text>\n\n  <!-- Message Flow Arrow down -->\n  <line x1=\"200\" y1=\"100\" x2=\"200\" y2=\"120\" stroke=\"#38bdf8\" stroke-width=\"1.5\" stroke-dasharray=\"3 3\"/>\n  <text class=\"text-accent-blue\" x=\"205\" y=\"113\" fill=\"#38bdf8\" font-size=\"8\">Message Flow</text>\n\n  <!-- Bottom Pool: Perusahaan (White-Box Pool with Swimlanes) -->\n  <rect class=\"svg-card\" x=\"30\" y=\"120\" width=\"620\" height=\"110\" rx=\"6\" fill=\"#1e293b\" stroke=\"#a855f7\" stroke-width=\"1.5\"/>\n  <text class=\"text-accent-purple\" x=\"40\" y=\"138\" fill=\"#a855f7\" font-size=\"9\" font-weight=\"700\">POOL 2: PERUSAHAAN (INTERNAL)</text>\n\n  <!-- Lane 1: Sales -->\n  <line x1=\"30\" y1=\"145\" x2=\"650\" y2=\"145\" stroke=\"#334155\"/>\n  <rect class=\"svg-subcard\" x=\"40\" y=\"152\" width=\"70\" height=\"68\" rx=\"4\" fill=\"#0f172a\" stroke=\"#334155\"/>\n  <text class=\"svg-muted\" x=\"75\" y=\"175\" fill=\"#94a3b8\" font-size=\"8\" font-weight=\"700\" text-anchor=\"middle\">LANE 1:</text>\n  <text class=\"text-accent-blue\" x=\"75\" y=\"190\" fill=\"#38bdf8\" font-size=\"8\" font-weight=\"600\" text-anchor=\"middle\">Penjualan</text>\n\n  <!-- Step 1: Start Event -->\n  <circle cx=\"140\" cy=\"186\" r=\"12\" fill=\"#064e3b\" stroke=\"#34d399\" stroke-width=\"2\"/>\n  <text class=\"text-accent-green\" x=\"140\" y=\"190\" fill=\"#34d399\" font-size=\"8\" font-weight=\"700\" text-anchor=\"middle\">Start</text>\n\n  <!-- Sequence Arrow -->\n  <line x1=\"152\" y1=\"186\" x2=\"175\" y2=\"186\" stroke=\"#cbd5e1\" stroke-width=\"1.5\"/>\n\n  <!-- Step 2: Activity Receive Order -->\n  <rect class=\"svg-subcard\" x=\"175\" y=\"168\" width=\"90\" height=\"36\" rx=\"6\" fill=\"#0f172a\" stroke=\"#38bdf8\"/>\n  <text class=\"svg-text\" x=\"220\" y=\"184\" fill=\"#cbd5e1\" font-size=\"8\" font-weight=\"600\" text-anchor=\"middle\">Catat Pesanan</text>\n  <text class=\"svg-muted\" x=\"220\" y=\"196\" fill=\"#94a3b8\" font-size=\"7\" text-anchor=\"middle\">(Sales Order)</text>\n\n  <!-- Sequence Arrow -->\n  <line x1=\"265\" y1=\"186\" x2=\"295\" y2=\"186\" stroke=\"#cbd5e1\" stroke-width=\"1.5\"/>\n\n  <!-- Step 3: Gateway (Credit Check) -->\n  <polygon points=\"315,168 335,186 315,204 295,186\" fill=\"#451a03\" stroke=\"#f59e0b\" stroke-width=\"1.5\"/>\n  <text class=\"text-accent-amber\" x=\"315\" y=\"190\" fill=\"#fbbf24\" font-size=\"10\" font-weight=\"800\" text-anchor=\"middle\">&#215;</text>\n\n  <!-- Branch No -> Reject End -->\n  <line x1=\"315\" y1=\"168\" x2=\"315\" y2=\"155\" stroke=\"#f43f5e\" stroke-width=\"1.5\"/>\n  <circle cx=\"315\" cy=\"150\" r=\"8\" fill=\"#7f1d1d\" stroke=\"#f43f5e\" stroke-width=\"2\"/>\n  <text class=\"text-accent-red\" x=\"330\" y=\"153\" fill=\"#f87171\" font-size=\"7\">Tolak</text>\n\n  <!-- Branch Yes -> Warehouse & Billing -->\n  <line x1=\"335\" y1=\"186\" x2=\"365\" y2=\"186\" stroke=\"#34d399\" stroke-width=\"1.5\"/>\n  <text class=\"text-accent-green\" x=\"348\" y=\"180\" fill=\"#34d399\" font-size=\"7\">Disetujui</text>\n\n  <!-- Step 4: Parallel Activities -->\n  <rect class=\"svg-subcard\" x=\"365\" y=\"160\" width=\"100\" height=\"24\" rx=\"4\" fill=\"#0f172a\" stroke=\"#34d399\"/>\n  <text class=\"svg-text\" x=\"415\" y=\"176\" fill=\"#cbd5e1\" font-size=\"7.5\" font-weight=\"600\" text-anchor=\"middle\">Keluarkan Barang Gudang</text>\n\n  <rect class=\"svg-subcard\" x=\"365\" y=\"190\" width=\"100\" height=\"24\" rx=\"4\" fill=\"#0f172a\" stroke=\"#f59e0b\"/>\n  <text class=\"svg-text\" x=\"415\" y=\"206\" fill=\"#cbd5e1\" font-size=\"7.5\" font-weight=\"600\" text-anchor=\"middle\">Terbitkan Faktur Tagihan</text>\n\n  <!-- Sequence Arrow to End -->\n  <line x1=\"465\" y1=\"186\" x2=\"510\" y2=\"186\" stroke=\"#cbd5e1\" stroke-width=\"1.5\"/>\n\n  <!-- Step 5: End Event -->\n  <circle cx=\"530\" cy=\"186\" r=\"14\" fill=\"#7f1d1d\" stroke=\"#f43f5e\" stroke-width=\"3\"/>\n  <text class=\"text-accent-red\" x=\"530\" y=\"190\" fill=\"#f87171\" font-size=\"8\" font-weight=\"700\" text-anchor=\"middle\">End</text>\n\n  <!-- SoD Box highlight -->\n  <rect class=\"svg-subcard\" x=\"560\" y=\"152\" width=\"80\" height=\"68\" rx=\"4\" fill=\"#0f172a\" stroke=\"#a855f7\"/>\n  <text class=\"text-accent-purple\" x=\"600\" y=\"170\" fill=\"#a855f7\" font-size=\"7.5\" font-weight=\"700\" text-anchor=\"middle\">KONTROL SoD:</text>\n  <text class=\"svg-muted\" x=\"600\" y=\"184\" fill=\"#94a3b8\" font-size=\"7\" text-anchor=\"middle\">Sales &#8800; Gudang</text>\n  <text class=\"svg-muted\" x=\"600\" y=\"196\" fill=\"#94a3b8\" font-size=\"7\" text-anchor=\"middle\">Kredit &#8800; Sales</text>\n  <text class=\"text-accent-green\" x=\"600\" y=\"210\" fill=\"#34d399\" font-size=\"7\" font-weight=\"600\" text-anchor=\"middle\">&#10003; Minim Fraud</text>\n</svg>"
},
    {
      "kind": "h2",
