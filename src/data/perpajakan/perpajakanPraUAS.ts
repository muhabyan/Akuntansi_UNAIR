      ...
      "pages": [
        {
          ...
          "blocks": [
            ...
            {
              "k": "p",
              "text": "💡 **Glosarium Istilah & Singkatan:**\n- **§** : Simbol Pasal atau Bagian (contoh: \"lihat §4\" berarti lihat Pasal/Bagian 4).\n- **KUP** : Ketentuan Umum dan Tata Cara Perpajakan.\n- **DJP** : Direktorat Jenderal Pajak.\n- **WP** : Wajib Pajak.\n- **SPT** : Surat Pemberitahuan.\n- **SKP** : Surat Ketetapan Pajak (SKPKB = Kurang Bayar, SKPKBT = Kurang Bayar Tambahan, SKPN = Nihil, SKPLB = Lebih Bayar).\n- **STP** : Surat Tagihan Pajak.\n- **SP2DK** : Surat Permintaan Penjelasan atas Data dan/atau Keterangan.\n- **PMK** : Peraturan Menteri Keuangan."
            }
          ]
        },
        {
      ...
      "pages": [
        ...
        },
        {
          ...
          "blocks": [
            ...
            {
              "k": "pre",
              "text": "Tarif bunga per bulan = (Suku Bunga Acuan + Uplift Factor) ÷ 12\n\n💡 Analogi Kartu Kredit: Bank Indonesia punya suku bunga dasar. Makin jelek riwayat bayarmu, bank ngasih bunga tambahan (Uplift Factor). Di pajak juga sama, makin berat tingkat pelanggaran/kesalahanmu, *Uplift Factor*-nya makin tinggi."
            },
            {
              "k": "list",
              "items": [
