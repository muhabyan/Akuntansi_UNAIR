...
const root = path.resolve(process.env.UX10B1_RELEASE_ROOT || process.cwd());
const mode = process.env.UX10B1_VERIFY_MODE || 'release';
const manifestName = 'UX1_0B_1_PACKAGE_MANIFEST_SHA256.txt';
