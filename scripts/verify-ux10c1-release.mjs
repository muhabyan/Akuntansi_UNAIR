...
const root = path.resolve(process.env.UX10C1_RELEASE_ROOT || process.cwd());
const mode = process.env.UX10C1_VERIFY_MODE || 'release';
const manifestName = 'UX1_0C_1_PACKAGE_MANIFEST_SHA256.txt';
