...
//
// Edited by hand, never generated: AKK202, AKS301, PJK301 (formerly PJK202; all artefacts), AKA201 (all artefacts; TM01–TM07
// rebuilt from the content package) and the quiz and bank soal of AKS201 and MNK201 (expanded in eb2282c). The flashcards of AKS201 and MNK201 still match their generator.
import assert from 'node:assert/strict';
import { readFileSync } from 'node:fs';

const GENERATED = {
  flashcards: ['AKM202', 'AKS201', 'MNK201'],
  quizzes: ['AKM202'],
  banksoal: ['AKM202'],
};
