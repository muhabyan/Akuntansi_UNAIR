...
const root = path.resolve(process.env.UX10D_RELEASE_ROOT || process.cwd());
const mode = process.env.UX10D_VERIFY_MODE || 'release';
const manifestName = 'UX1_0D_PACKAGE_MANIFEST_SHA256.txt';
