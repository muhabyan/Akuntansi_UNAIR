...
const root = path.resolve(process.env.UX10B_RELEASE_ROOT || process.cwd());
const mode = process.env.UX10B_VERIFY_MODE || 'release';
const manifestName = 'UX1_0B_PACKAGE_MANIFEST_SHA256.txt';
