...
const root = path.resolve(process.env.UX10D2_RELEASE_ROOT || process.cwd());
const mode = process.env.UX10D2_VERIFY_MODE || 'release';
const manifestName = 'UX1_0D_2_PACKAGE_MANIFEST_SHA256.txt';
