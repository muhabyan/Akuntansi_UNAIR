...
const root = path.resolve(process.env.UX10C_RELEASE_ROOT || process.cwd());
const mode = process.env.UX10C_VERIFY_MODE || 'release';
const manifestName = 'UX1_0C_PACKAGE_MANIFEST_SHA256.txt';
