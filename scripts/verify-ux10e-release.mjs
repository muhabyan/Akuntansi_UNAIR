...
const root = path.resolve(process.env.UX10E_RELEASE_ROOT || process.cwd());
const mode = process.env.UX10E_VERIFY_MODE || 'release';
const manifestName = 'UX1_0E_PACKAGE_MANIFEST_SHA256.txt';
