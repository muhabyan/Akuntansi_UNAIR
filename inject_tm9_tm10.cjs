...
const parsedTm9 = JSON.parse(fs.readFileSync('c:/cek/tm9_perfect.json', 'utf-8'));
const parsedTm10 = JSON.parse(fs.readFileSync('c:/cek/tm10_perfect.json', 'utf-8'));
...
const tm9Str = `const tm9: Reading = ${JSON.stringify(parsedTm9, null, 2)};\n\n`;
const tm10Str = `const tm10: Reading = ${JSON.stringify(parsedTm10, null, 2)};\n\n`;
